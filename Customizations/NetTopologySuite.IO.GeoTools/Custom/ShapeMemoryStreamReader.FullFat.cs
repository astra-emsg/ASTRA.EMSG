...
{
    public partial class ShapeMemoryStreamReader
    {
        /// <summary>
        ...
        public ShapeMemoryStreamReader(Stream inputStream, IGeometryFactory geometryFactory)
        {
            if (inputStream == null)
            ...
            var shpBinaryReader = new BigEndianBinaryReader(_inputStream);
