...
{
    public partial class ShapeMemoryStreamDataReader : IEnumerable, IDataReader, IDataRecord
    {
        ...
        {
            private ShapeMemoryStreamDataReader _parent;

            /// <summary>
            /// 
            /// </summary>
            /// <param name="parent"></param>
            public ShapefileDataReaderEnumerator(ShapeMemoryStreamDataReader parent)
            {
                _parent = parent;
                _parent.Reset();
            }
