...
namespace NetTopologySuite.IO
{
    ...
    /// </summary>
    public partial class ShapeMemoryStreamReader : IEnumerable
    {
        ...
        public ShapeMemoryStreamReader(Stream inputStream) :
            this(inputStream, new GeometryFactory())
        {
        }
        ...
        private partial class ShapefileEnumerator : IEnumerator, IDisposable
        {
            ...
            private readonly ShapeMemoryStreamReader _parent;
