(function () {
    ...
    Parent.ConditionIndex = $.inherit(Parent,
  {
   ...
   , constructor: function (map) {
       ...
       this.urls.PARENTS = this.app.config.get('GIS.CONTROLLER.GET_STRABS_BY_ID');
       this.urls.PARENT_AT = this.app.config.get('GIS.CONTROLLER.GET_STRABS_AT');
       this.urls.MAIN_AT = this.app.config.get('GIS.CONTROLLER.GET_ZABS_AT');
       this.urls.MAIN_ID = this.app.config.get('GIS.CONTROLLER.GET_ZABS_BY_ID');
       this.type = "ZABS";
       this.references = [];
   }
   ...
   , redraw: function () {
       ...
       if (this.map.zabstrot) {
           this.map.zabstrot.redraw(true);
       }
   }
