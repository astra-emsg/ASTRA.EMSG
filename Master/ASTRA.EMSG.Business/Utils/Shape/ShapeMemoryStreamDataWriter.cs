...
namespace ASTRA.EMSG.Business.Utils.Shape
{
    ...
    /// </summary>
    public class ShapeMemoryStreamDataWriter
    {
        ...
        private ShapeMemoryStreamWriter shapeWriter = null;
        private DbaseMemoryStreamWriter dbaseWriter = null;
        ...
        public ShapeMemoryStreamDataWriter() : this(NetTopologySuite.Geometries.GeometryFactory.Default) { }
        ...
        public ShapeMemoryStreamDataWriter(IGeometryFactory geometryFactory)
        {
            ...
            // Writers
            shapeWriter = new ShapeMemoryStreamWriter(geometryFactory);
            dbaseWriter = new DbaseMemoryStreamWriter();
        }

        public MemoryStream GetShpStream()
        {
            return shapeWriter.GetShpStream();
        }

        public MemoryStream GetShxStream()
        {
            return shapeWriter.GetShxStream();
        }

        public MemoryStream GetDbfStream()
        {
            return dbaseWriter.GetDbfStream();
        }
