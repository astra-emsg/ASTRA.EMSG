...
{
    [Serializable]
    public class RealisierteMassnahmeModel : Model
    {
        ...
        public string MassnahmenvorschlagFahrbahnBezeichnung { get; set; }

        public Guid? MassnahmenvorschlagTrottoir { get; set; }
        public string MassnahmenvorschlagTrottoirBezeichnung { get; set; }
