...
{
    public class TrottoirShapeFileConstants
    {

        public static readonly string StrassenabschnittID = "RDID";
        public static readonly string ZustandsAbschnittID = "CNDID";
        ...
        public static readonly string Breite = "SWWIDTH";
        public static readonly string Lage = "SIDE";
        ...
        public static readonly string Zustandsindex = "SWCONID";
        public static readonly string Massnahmenvorschlag = "SWMAINREC";
        public static readonly string Kosten = "SWCOST";
        public static readonly string Dringlichkeit = "SWPRIO";
        public static readonly string Gesamtkosten = "SWTOTCOST";
