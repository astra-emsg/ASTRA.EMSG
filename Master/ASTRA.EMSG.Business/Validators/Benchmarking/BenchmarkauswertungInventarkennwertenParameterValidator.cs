...
{
    public class BenchmarkauswertungInventarkennwertenParameterValidator : AbstractValidatorBase<BenchmarkauswertungInventarkennwertenParameter>
    {
        public BenchmarkauswertungInventarkennwertenParameterValidator(ILocalizationService localizationService) : base(localizationService)
        {
