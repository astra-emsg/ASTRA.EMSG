...
{
    public class EineListeVonRealisiertenMassnahmenGeordnetNachJahrenParameter : EmsgTabellarischeReportParameter, IErfassungsPeriodVonBisFilter, IProjektnameFilter, ICurrentMandantFilter
    {
